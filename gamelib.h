...
//função para fazer o encerramento do programa
//endGame(integer) -> finaliza o jogo com a mensagem esperada de acordo com o integer passado (modo de término recebido por checkTable) 
